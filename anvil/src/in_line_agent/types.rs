...
impl InLineAgent {
    ...
    async fn decide_action(
        ...
        dbg!("anvil.inline_completion.decide_action");
    ...
    async fn generate_documentation(
        ...
        if document_nodes.is_empty() {
            ...
            dbg!("anvil.inline_completion.generate_documentation");
    ...
    async fn process_edit(
        ...
        dbg!("anvil.inline_completion.process_edit");
        ...
        dbg!("anvil.function_nodes.len", &function_nodes.len());
