...
impl Agent {
    ...
    pub async fn answer(
        ...
        dbg!("anvil.generating_context.followup_question");
        ...
        dbg!("anvil.generating_answer.history_complete");
        ...
        let messages_roles = messages
            ...
            .collect::<Vec<_>>();
        dbg!("anvil.generating_answer.messages", &messages_roles);
        ...
        // dbg!("anvil.generating_ansewr.fixed_roles", &fixed_roles);
