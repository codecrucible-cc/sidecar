...
impl ToolBox {
    ...
    // TODO(codecrucible): This needs more love, the position we are getting back
    ...
    pub async fn find_implementation_block_for_sub_symbol(
        ...
        if language_config.language_str == "rust" {
            ...
            match valid_position {
                ...
                None => {
                    // TODO(codecrucible): Handle the none case here when we do not find
...
{thinking}"#
    ...
    // TODO(codecrucible): This part of the puzzle is still messed up since we are rewriting the whole
...
{symbol_name}
    ...
    /// the world looks like with tree-sitter and anvil
    ...
    pub async fn get_symbol_change_set(
        ...
        // TODO(codecrucible): This is still wrong btw, the true meaning of a symbol-identifier
...
{code_outlines}
    ...
    pub async fn warmup_context(
        ...
        let search_and_replace_request = SearchAndReplaceEditingRequest::new(
            ...
            vec![],
            message_properties.cancellation_token(),
            // no ccde rules during the warmup phase
            None,
...
{joined_journey}"
    ...
    pub async fn generate_plan(
        ...
        // pick up from here about passing.ccderules everywhere and then look at the tool use agent
