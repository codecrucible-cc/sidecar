...
impl LLMProviderAPIKeys {
    ...
    pub fn provider_type(&self) -> LLMProvider {
        match self {
            ...
            LLMProviderAPIKeys::CodeCrucible => {
    ...
    pub fn key(&self, llm_provider: &LLMProvider) -> Option<Self> {
        match llm_provider {
            ...
            LLMProvider::CodeCrucible(_) => Some(LLMProviderAPIKeys::CodeCrucible),
...
<item>
<file_path>
anvil/src/agentic/tool/filtering/broker.rs:136-143
</file_path>
<content>
```rust
#[derive(Debug, Clone)]
...
<code_symbol>
<file_path>
anvil/llm_prompts/src/fim/types.rs
</file_path>
<name>
...
<code_symbol>
<file_path>
anvil/llm_client/src/clients/types.rs
</file_path>
<name>
...
<selection_item>
<file_path>
anvil/llm_prompts/src/fim/deepseek.rs
</file_path>
<content>
```rust
...
<selection_item>
<file_path>
anvil/llm_prompts/src/fim/grok.rs
</file_path>
<content>
```rust
...
<code_selection>
<file_path>
{root_directory}anvil/broker/fill_in_middle.rs
</file_path>
```rust
pub struct FillInMiddleBroker {{
    providers: HashMap<LLMType, Box<dyn FillInMiddleFormatter + Send + Sync>>,
...
Another example:
<file_path>
{root_directory}anvil/bin/webserver.rs
</file_path>
<code_selection>
```rust
...
//         response: &str,
//     ) -> std::io::Result<()> {
//         let traces_dir_path = PathBuf::from("/Users/zi/codecrucible/anvil/traces");
...
<file_path>
/Users/skcd/scratch/anvil/llm_client/src/provider.rs
</file_path>
<thinking>
...
<file_path>
/Users/skcd/scratch/anvil/llm_client/src/broker.rs
</file_path>
<thinking>
...
<file_path>
/Users/skcd/scratch/anvil/llm_client/src/clients/groq.rs
</file_path>
<thinking>
...
<file_path>
/Users/skcd/scratch/anvil/anvil/src/webserver/agent.rs
</file_path>
<thinking>
...
<file_path>/Users/skcd/test_repo/anvil/anvil/src/agentic/symbol/ui_event.rs</file_path>
...
<file_path>
/Users/skcd/test_repo/anvil/anvil/src/agentic/symbol/tool_box.rs
</file_path>
<step>
