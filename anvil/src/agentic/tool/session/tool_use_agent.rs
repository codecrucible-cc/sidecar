...
impl ToolUseAgentProperties {
    pub fn new(in_editor: bool, repo_name: Option<String>, ccde_rules: Option<String>) -> Self {
        Self {
            in_editor,
            repo_name,
            ccde_rules,
...
{steps}
    ...
    fn system_message(&self, context: &ToolUseAgentInput) -> String {
        ...
        let ccde_rules = match self.properties.ccde_rules.clone() {
            Some(ccde_rules) => {
                format!(
                    "
...
<grep_string>
<directory_path>/Users/skcd/test_repo/anvil</directory_path>
