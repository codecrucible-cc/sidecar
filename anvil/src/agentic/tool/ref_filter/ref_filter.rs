...
<reference>
ReferenceFilterRequest in /Users/zi/codecrucible/testing/anvil/anvil/src/agentic/tool/ref_filter/ref_filter.rs
impl ReferenceFilterRequest {
    pub fn new(
        user_instruction: String,
        llm_properties: LLMProperties,
...
<reference>
ToolInput in /Users/zi/codecrucible/testing/anvil/anvil/src/agentic/tool/input.rs
#[derive(Debug, Clone)]
pub enum ToolInput {
