...
pub async fn reach_the_devs() -> impl IntoResponse {
    json(ReachTheDevsResponse {
        response: r#"
        You made it here! Reach out to skcd@codecrucible.ai or ghost@codecrucible.ai, we would love to talk to you about joining codecrucible's hacker first dev team
        "#.to_owned(),
    })
}
