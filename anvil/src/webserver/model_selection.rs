...
mod tests {
    use llm_client::provider::{
        AzureConfig, CodeCrucibleLLMTypes, LLMProvider, LLMProviderAPIKeys, OllamaProvider,
    };
    ...
    fn test_json_should_convert_properly() {
        let data = r#"
        {"slow_model":"MistralInstruct","fast_model":"Gpt4","models":{"Gpt4Turbo":{"context_length":128000,"temperature":0.2,"provider":{"Azure":{"deployment_id":""}}},"Gpt4_32k":{"context_length":32768,"temperature":0.2,"provider":{"Azure":{"deployment_id":""}}},"Gpt4":{"context_length":8192,"temperature":0.2,"provider":{"Azure":{"deployment_id":"gpt4-access"}}},"GPT3_5_16k":{"context_length":16385,"temperature":0.2,"provider":{"Azure":{"deployment_id":"gpt35-turbo-access"}}},"GPT3_5":{"context_length":4096,"temperature":0.2,"provider":{"Azure":{"deployment_id":""}}},"Mixtral":{"context_length":32000,"temperature":0.2,"provider":"TogetherAI"},"MistralInstruct":{"context_length":8000,"temperature":0.2,"provider":"TogetherAI"}},"providers":[{"OpenAI":{"api_key":""}},{"OpenAIAzureConfig":{"deployment_id":"","api_base":"https://codecrucible-gpt4.openai.azure.com","api_key":"89ca8a49a33344c9b794b3dabcbbc5d0","api_version":"2023-08-01-preview"}},{"TogetherAI":{"api_key":"cc10d6774e67efef2004b85efdb81a3c9ba0b7682cc33d59c30834183502208d"}},{"Ollama":{}}]}
        "#;
        assert!(serde_json::from_str::<LLMClientConfig>(data).is_ok());
    }

    #[test]
    fn test_json_should_convert_properly_codecrucible() {
        let provider = LLMProvider::CodeCrucible(CodeCrucibleLLMTypes { llm_type: None });
        println!("{:?}", serde_json::to_string(&provider));
        let data = r#"
        {"slow_model":"DeepSeekCoder33BInstruct","fast_model":"DeepSeekCoder33BInstruct","models":{"Gpt4":{"context_length":8192,"temperature":0.2,"provider":"CodeCrucible"}},"providers":["CodeCrucible",{"OpenAIAzureConfig":{"deployment_id":"","api_base":"https://codecrucible-gpt4.openai.azure.com","api_key":"89ca8a49a33344c9b794b3dabcbbc5d0","api_version":"2023-08-01-preview"}},{"TogetherAI":{"api_key":"cc10d6774e67efef2004b85efdb81a3c9ba0b7682cc33d59c30834183502208d"}},{"OpenAICompatible":{"api_key":"somethingelse","api_base":"testendpoint"}},{"Ollama":{}}]}
        "#;
        assert!(serde_json::from_str::<LLMClientConfig>(data).is_ok());
    }
    ...
    fn test_gemini_type() {
        let data = r#"
        {"slow_model":"DeepSeekCoder33BInstruct","fast_model":"DeepSeekCoder33BInstruct","models":{"Gpt4":{"context_length":8192,"temperature":0.2,"provider":{"CodeCrucible":{"llm_type":null}}},"GPT3_5_16k":{"context_length":16385,"temperature":0.2,"provider":{"CodeCrucible":{"llm_type":null}}},"CodeLlama7BInstruct":{"context_length":16384,"temperature":0.2,"provider":{"CodeCrucible":{"llm_type":null}}},"DeepSeekCoder33BInstruct":{"context_length":16384,"temperature":0.2,"provider":{"CodeCrucible":{"llm_type":null}}},"DeepSeekCoder1.3BInstruct":{"context_length":16384,"temperature":0.2,"provider":"Ollama"},"DeepSeekCoder6BInstruct":{"context_length":16384,"temperature":0.2,"provider":"Ollama"},"ClaudeSonnet":{"context_length":200000,"temperature":0.2,"provider":{"CodeCrucible":{"llm_type":null}}},"ClaudeHaiku":{"context_length":200000,"temperature":0.2,"provider":{"CodeCrucible":{"llm_type":null}}},"GeminiPro1.5":{"context_length":1000000,"temperature":0.2,"provider":null}},"providers":["CodeCrucible",{"Ollama":{}},{"GeminiPro":{"api_key":"ya29.a0Ad52N3-fixk_UEEgKks633q1SaF6YmrY5vt9VroX40j7nqfU5Ny4S_aLH-AzNDXPfAGxOQXGMSD_LTlQYgSYQYEtKlIWIulI1HD9o9wNSkbGP_EawaEhf4UNZe8hwKDQfv9h2727V3on25fLjS_YsRfJTR3Iz9F-ZOQv6tBAfwaCgYKAZMSARESFQHGX2MiNXTyT7SzpY5qnOijIPOc4A0177","api_base":"anton-390822"}}]}
        "#.to_owned();
    ...
    fn test_custom_llm_type_json() {
        ...
        assert_eq!(client_config_str, "{\"slow_model\":\"slow_model\",\"fast_model\":\"fast_model\",\"models\":{\"slow_model\":{\"context_length\":16000,\"temperature\":0.2,\"provider\":{\"Azure\":{\"deployment_id\":\"gpt35-turbo-access\"}}}},\"providers\":[{\"OpenAIAzureConfig\":{\"deployment_id\":\"gpt35-turbo-access\",\"api_base\":\"https://codecrucible-gpt4.openai.azure.com\",\"api_key\":\"89ca8a49a33344c9b794b3dabcbbc5d0\",\"api_version\":\"v1\"}}]}");
    }
}
