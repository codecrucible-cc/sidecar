...
use llm_client::clients::codecrucible::CodeCrucibleClient;
...
> {
    let codecrucible_client =
        CodeCrucibleClient::new("https://codecrucible-provider-dot-anton-390822.ue.r.appspot.com");
...
{data}"#
        ...
        let reranked_snippet = rerank_snippets(&codecrucible_client, snippets, &user_query).await;
