...
use anvil::agentic::tool::lsp::list_files::list_files;
use std::error::Error;
...
#[tokio::main]
async fn main() {
    let directory_path = Path::new("/Users/skcd/scratch/anvil");
    let files = list_files(&directory_path, true, 10_000).0;
    let find_parameters = FindParams {
        search_directory: "/Users/skcd/scratch/anvil".to_owned(),
