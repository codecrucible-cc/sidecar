...
#[tokio::main]
async fn main() {
    // let full_path = Path::new("/Users/zi/codecrucible/anvil/anvil/src");
    // let tag_index = TagIndex::from_path(full_path).await;
    let _files = vec![
        "/Users/skcd/scratch/anvil/anvil/src/repomap/tag.rs".to_owned(),
        "/Users/skcd/scratch/anvil/anvil/src/repomap/types.rs".to_owned(),
    ];

    let root_path = Path::new("/Users/skcd/scratch/anvil/anvil/src/agentic/tool");
