...
async fn main() {
    ...
    // let file_path = "/Users/skcd/test_repo/anvil/llm_client/src/provider.rs";
    // let _file_paths =
    //     vec!["/Users/skcd/test_repo/anvil/anvil/src/agentic/symbol/ui_event.rs".to_owned()];
    // let file_paths = vec![
    ...
    //         .to_owned();
    // let file_paths = vec![
    //     "/Users/skcd/test_repo/anvil/anvil/src/webserver/agentic.rs".to_owned(),
    //     "/Users/skcd/test_repo/anvil/anvil/src/bin/webserver.rs".to_owned(),
    // ];
    // let file_paths =
    //     vec!["/Users/skcd/test_repo/anvil/llm_client/src/clients/types.rs".to_owned()];
    ...
    //     "can you add a new method to CodeCrucibleLLMTypes for setting the llm type?".to_owned();
    ...
    let root_dir = "/Users/zi/codecrucible/anvil/anvil/src";
